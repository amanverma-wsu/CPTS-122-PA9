...
void initialize()
{
    ...
    //// Player 1  ////
    player1_cord[0][0] = 120;
    player1_cord[0][1] = 600;

    player1_cord[1][0] = 120;
    player1_cord[1][1] = 500;

    player1_cord[2][0] = 220;
    player1_cord[2][1] = 600;

    player1_cord[3][0] = 220;
    player1_cord[3][1] = 500;

    //// Player 2  ////
    player2_cord[0][0] = 500;
    player2_cord[0][1] = 600;

    player2_cord[1][0] = 600;
    player2_cord[1][1] = 600;

    player2_cord[2][0] = 500;
    player2_cord[2][1] = 500;

    player2_cord[3][0] = 600;
    player2_cord[3][1] = 500;

    //// Player 3  ////
    player3_cord[0][0] = 120;
    player3_cord[0][1] = 225;

    player3_cord[1][0] = 220;
    player3_cord[1][1] = 225;

    player3_cord[2][0] = 120;
    player3_cord[2][1] = 110;

    player3_cord[3][0] = 220;
    player3_cord[3][1] = 110;

    //// Player 4  ////
    player4_cord[0][0] = 500;
    player4_cord[0][1] = 225;

    player4_cord[1][0] = 600;
    player4_cord[1][1] = 225;

    player4_cord[2][0] = 500;
    player4_cord[2][1] = 110;

    player4_cord[3][0] = 600;
    player4_cord[3][1] = 110;
